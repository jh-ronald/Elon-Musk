...
dl <- tempfile()
download.file("https://raw.githubusercontent.com/jh-ronald/Study-on-EM/master/Elon%202017-2018.csv",
              destfile = dl)
elon_tweets_1718 <- read_csv(dl)

dl <- tempfile()
download.file("https://raw.githubusercontent.com/jh-ronald/Study-on-EM/master/Elon%202018-2019.csv",
              destfile = dl)
